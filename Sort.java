...
public class Sort {
    ...
    //removes the duplicate numbers within the array and makes the duplicates 0 and moves to the end of the array
    public static void removeDups(int[] arr)
    {
         ...
         //occurs when they are not duplicates
         for (int i = 1; i < arr.length; ++i) 
         {
         ...
         //making the duplicates 0 in the end of the array
         for (int i = ++prevPos; i < arr.length; ++i) 
         {
             arr[i] = 0;
         }
         for (int i = 0; i < arr.length; i++)
    ...
    public static void main(String[] arr) { 
        ...
        //removeDups 
        System.out.print("Testing of removing duplicates: ");
        removeDups(orig);
    }
